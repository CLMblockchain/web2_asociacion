...
export const SOCIALS = [
  {
    name: "Telegram",
    url: "https://t.me/+4QeI7xwu-0Q0ZTg0",
    icon: IconTelegram,
  },
  {
    name: "Github",
    url: "https://github.com/CLMblockchain",
    icon: IconGithub,
  },
  {
    name: "Linkedin",
    url: "https://www.linkedin.com/company/asociacion-blockchain-de-castilla-la-mancha/",
    icon: IconLinkedin,
  },
  {
    name: "Discord",
    url: "https://discord.gg/BvvYmCAA",
    icon: IconDiscord,
  },
];
